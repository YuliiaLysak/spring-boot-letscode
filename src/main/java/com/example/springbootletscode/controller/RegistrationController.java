...
import com.example.springbootletscode.domain.dto.CaptchaResponseDto;
import com.example.springbootletscode.service.UserService;
...
public class RegistrationController {
    private final static String CAPTCHA_URL = "https://www.google.com/" +
            "recaptcha/api/siteverify?secret=%s&response=%s";
